...
class ItemDetailEditFrame(tk.Frame):
    ...
    def create_widgets(self):
        ...
        self.tittle_label = ttk.Entry(self.tittle_frame, width=50, font=('方正小标宋_GBK', 22), style="TittleFont.TEntry")
        ...
        self.upload_button = ttk.Button(self.upload_button_frame, text="更改图片", style='ButtonFont.TButton',
                                        takefocus=False)
        self.upload_button.config(command=lambda: self.upload_image())
        self.upload_button.pack(side='left', padx=(10, 0), pady=(0, 0))
        self.upload_button_frame.pack(side='top', padx=(20, 0), pady=(0, 0))
        ...
        self.price_label.pack(side='left', padx=(0, 40), pady=(5, 5))
        self.price_value_label = ttk.Entry(self.price_frame, width=15, font=('方正小标宋_GBK', 12), style="ItemDetailPriceFont.TEntry")
        self.price_value_label.insert('end', self.price)
        self.price_value_label.pack(side='left', padx=(0, 0), pady=(5, 5))
        self.price_frame.pack(side='top', padx=(0, 50), pady=(20, 5))
        ...
        self.tag_label.pack(side='left', padx=(0, 40), pady=(0, 5))
        ...
        self.tag_dropdown.pack(side='left', padx=(0, 40), pady=(0, 5))
        self.tag_frame.pack(side='top', padx=(0,0), pady=(5,5))
        ...
        self.desc_frame.pack(side='top', padx=(10, 0), pady=(5, 10))
        ...
        self.edit_button_frame.pack(side='top', padx=(10, 0), pady=(70, 10))

        self.attributes_frame.pack(side='left', padx=(40, 10), pady=(20, 0))
